...
import me.zoom.hackhack.module.modules.client.CommandColor;
...
public abstract class Command {
    ...
    public static void sendClientMessage(String message){
            if (MsgWaterMark)
                mc.player.sendMessage(new TextComponentString(CommandColor.getBrackets() + "[" + CommandColor.getTextColor() + "HackHack" + CommandColor.getBrackets() + "] " + ChatFormatting.RESET + cf + message));
            else
