 ...
 */
    ...
    public void onWorldRender(RenderEvent event) {
        if (this.render != null) {
            ...
            RenderUtil.drawBox(this.render, new Color(colorRed.getValue(), colorGreen.getValue(), colorBlue.getValue(), colorAlpha.getValue()).getRGB(), 6);
        ...
        if(showDamage.getValue()){
            if (this.render != null && this.renderEnt != null) {
                ...
                FontUtils.drawStringWithShadow(false, damageText, 0, 0, new Color(255,255,255).getRGB());
