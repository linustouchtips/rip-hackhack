    ...
    public void loadCombat(){
            ...
            while((line = br.readLine()) != null) {
                ...
                for(Module mm : ModuleManager.getModulesInCategory(Module.Category.Combat)) {
                    if (mm != null && mm.getName().equalsIgnoreCase(m)) {
                        mod = HackHack.getInstance().settingsManager.getSettingByNameAndModConfig(configname, mm);
        ...
        try {
            ...
            while((line = br.readLine()) != null) {
                ...
                for(Module mm : ModuleManager.getModulesInCategory(Module.Category.Combat)) {
                    if (mm != null && mm.getName().equalsIgnoreCase(m)) {
                        mod = HackHack.getInstance().settingsManager.getSettingByNameAndMod(configname, mm);
