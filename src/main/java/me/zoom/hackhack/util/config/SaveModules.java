...
public class SaveModules {
    ...
    public void saveCombat(){
        ...
        try {
            ...
            var3 = HackHack.getInstance().settingsManager.getSettingsByCategory(Module.Category.Combat).iterator();
            while(var3.hasNext()) {
                i = (Setting)var3.next();
    ...
    public void savePlayer(){
        ...
        try {
            ...
            out = new BufferedWriter(new FileWriter(file));
            var3 = HackHack.getInstance().settingsManager.getSettingsByCategory(Module.Category.Player).iterator();
            while(var3.hasNext()) {
                i = (Setting)var3.next();
                if (i.getType() == Setting.Type.DOUBLE) {
                    out.write(i.getConfigName() + ":" +((Setting.Double) i).getValue() + ":" + i.getParent().getName() + "\r\n");
    ...
    public void saveClient(){
        ...
        try {
            ...
            out = new BufferedWriter(new FileWriter(file));
            var3 = HackHack.getInstance().settingsManager.getSettingsByCategory(Module.Category.Client).iterator();
            while(var3.hasNext()) {
                i = (Setting)var3.next();
                if (i.getType() == Setting.Type.DOUBLE) {
                    out.write(i.getConfigName() + ":" +((Setting.Double) i).getValue() + ":" + i.getParent().getName() + "\r\n");
    ...
    public void saveMisc(){
        ...
        try {
            ...
            out = new BufferedWriter(new FileWriter(file));
            var3 = HackHack.getInstance().settingsManager.getSettingsByCategory(Module.Category.Misc).iterator();
            while(var3.hasNext()) {
                i = (Setting)var3.next();
                if (i.getType() == Setting.Type.DOUBLE) {
                    out.write(i.getConfigName() + ":" +((Setting.Double) i).getValue() + ":" + i.getParent().getName() + "\r\n");
    ...
    public void saveMovement(){
        ...
        try {
            ...
            out = new BufferedWriter(new FileWriter(file));
            var3 = HackHack.getInstance().settingsManager.getSettingsByCategory(Module.Category.Movement).iterator();
            while(var3.hasNext()) {
                i = (Setting)var3.next();
                if (i.getType() == Setting.Type.DOUBLE) {
                    out.write(i.getConfigName() + ":" +((Setting.Double) i).getValue() + ":" + i.getParent().getName() + "\r\n");
    ...
    public void saveRender(){
        ...
        try {
            ...
            out = new BufferedWriter(new FileWriter(file));
            var3 = HackHack.getInstance().settingsManager.getSettingsByCategory(Module.Category.Render).iterator();
            while(var3.hasNext()) {
                i = (Setting)var3.next();
                if (i.getType() == Setting.Type.DOUBLE) {
                    out.write(i.getConfigName() + ":" +((Setting.Double) i).getValue() + ":" + i.getParent().getName() + "\r\n");
