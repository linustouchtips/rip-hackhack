package me.zoom.hackhack.util.font;
...
public class FontUtils {
    ...
    public static float drawStringWithShadow(boolean customFont, String text, int x, int y, int color){
        if(customFont) return HackHack.fontRenderer.drawStringWithShadow(text, x, y, color);
    ...
    public static int getStringWidth(boolean customFont, String str){
        if(customFont) return HackHack.fontRenderer.getStringWidth(str);
        else return mc.fontRenderer.getStringWidth(str);
    }

    public static int getFontHeight(boolean customFont){
        if(customFont) return HackHack.fontRenderer.getHeight();
